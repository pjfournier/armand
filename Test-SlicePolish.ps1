...
$mistResult=Resolve-SliceIntent $s (ConvertTo-EngineIntent $mist.Intent);Assert ($mistResult.Accepted-and$mistResult.Events-match'reappears beside writing desk') 'Misty Step reaches valid visible destination'
