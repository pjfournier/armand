...
function New-EntityReference { param([string]$Id,[string]$Kind,[string]$DisplayName,[string[]]$Aliases=@(),[string[]]$Parts=@()) [pscustomobject]@{Id=$Id;Kind=$Kind;DisplayName=$DisplayName;Aliases=@($Aliases);Parts=@($Parts)} }
